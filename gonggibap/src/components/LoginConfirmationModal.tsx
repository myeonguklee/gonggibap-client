  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-700 rounded-xl p-6 max-w-sm w-[90%] z-50">
          <Dialog.Title className="text-lg text-center font-semibold mb-4">
            로그인
          </Dialog.Title>
